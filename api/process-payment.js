...
async function saveToSheet(data) {
  ...
  const playersText = data.categories
    .map((c) => `${c.label}: ${c.players.join(", ")}`)
    .join(" | ");
    ...
    html: `
      <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#1a1a1a">
        <div style="background:#16a34a;padding:28px 24px;text-align:center;border-radius:12px 12px 0 0">
          ...
          <p style="color:rgba(255,255,255,0.85);margin:6px 0 0;font-size:14px">Inscrição confirmada!</p>
        </div>
        <div style="background:#fff;padding:24px;border:1px solid #eee;border-top:none;border-radius:0 0 12px 12px">
          ...
          <p style="font-size:14px;color:#555;margin-bottom:20px">Sua inscrição foi confirmada com sucesso. Veja o resumo abaixo:</p>
    ...
    html: `
      <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#1a1a1a">
        <div style="background:#1a1a1a;padding:20px 24px;border-radius:12px 12px 0 0">
          <h2 style="color:#f0c040;margin:0;font-size:18px">Nova inscrição recebida</h2>
